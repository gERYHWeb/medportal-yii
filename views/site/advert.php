...
<main class="main ">
    <section class="section section-product  container clearfix">
        <div class="col-12">
			...
			isset( $data_advert['users']['nickname'] ) ? $nickname = $data_advert['users']['nickname'] : $nickname = '';
                        ...
                        <div class="sliderGalleryThumb product-gallery">
                            <div class="sliderGalleryThumb-big product-gallery-top">
                                <div class="item">
                                    ...
                                    <a href="/images/<?php echo $url_image ?>" data-fancybox="galleryProduct"
                            ...
                            <div class="sliderGalleryThumb-thumbs product-gallery-thumbnails ">
								...
								if ( isset( $image ) ) {
									foreach ( $image as $key => $val ) {
										?>
                                        <div class="thumb ">
                                            <img src="/images/<?php echo $val ?>" alt=""/>
                                        </div>
										<?php
									}
								}
                        ...
                        <div class="sidebar">
                            <div class="product-infoSidebar">
                                ...
                                <div class="profile-info">
                                    ...
                                    <div class="name">
                                        <span class="first"><?php echo $first_name != "" ? $first_name : $nickname ?></span>
                            ...
                            <div class="banners">
                                <a href="#" class="banner">
                                    <img src="/img/banner/banner1.png" alt="" class="img-fluid">
                                </a>
                                <a href="#" class="banner">
                                    <img src="/img/banner/banner2.png" alt="" class="img-fluid">
                                </a>
                            </div>
                        </div>
                    </div>
